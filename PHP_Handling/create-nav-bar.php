...
echo '<a href="../Pages/index.php" class="nav-links">Menu</a>';
...
echo '</div>';
echo '</div>';
echo '<a href="../Pages/index.php" style="color: white;display:inline;font-size: 300%;font-weight: bold;margin:0;padding:0; ">EVERYMAN  </a>';
